...
export const roleFamilies = pgTable("role_family", {
  ...
  slug: text("slug").notNull().unique(),
  name: text("name").notNull(),
  strongMatch: text("strong_match").array().notNull(),
  moderateMatch: text("moderate_match").array().notNull(),
  departmentBoost: text("department_boost").array().notNull(),
  departmentExclude: text("department_exclude").array().notNull(),
